...
I've been wanting to build an end-to-end ML project for a while now, and I finally had a good, relatively original idea: a cloud classifier! [Here's the GitHub repo.](https://github.com/oliverflood/clouds-ml)

<Aside variant="note">
  Presented here is a distilled retelling of the steps I took while working on
  this project. I've also included some mistakes, dead ends, and rabbit holes.
</Aside>
